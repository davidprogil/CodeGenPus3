...
#include "./codeGenPus/CGVG_ValidatorsGenerator.h"

int main(int argc, char *argv[]) {
	cout << "!!!Generator Validators!!!" << endl; // prints !!!Hello World!!!
	...
	if (isValid)
	{
		...
		if (isValid)
		{
			CGVG_ValidatorsGenerator validatorsGenerator(headerFh,sourceFh,abbreviation);
			printf("generating header... \n");
			validatorsGenerator.GenerateHeader(&interface);
			printf("generating source... \n");
			validatorsGenerator.GenerateSource(&interface);
		}
