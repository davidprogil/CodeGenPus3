...
#include "./codeGenPus/CGFG_SerializersGenerator.h"

int main(int argc, char *argv[]) {
	cout << "!!!Generator Serializers!!!" << endl; // prints !!!Hello World!!!
	...
	if (isValid)
	{
		...
		if (isValid)
		{
			CGFG_SerializersGenerator serializersGenerator(headerFh,sourceFh,abbreviation);
			printf("generating header... \n");
			serializersGenerator.GenerateHeader(&interface);
			printf("generating source... \n");
			serializersGenerator.GenerateSource(&interface);
		}
